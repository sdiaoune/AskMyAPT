...
export default function AskMyAPTLanding() {
  ...
  const [chatMessages, setChatMessages] = useState([
    ...
    { type: "user", message: "Do you allow pets?" },
    {
      type: "bot",
      message:
        "Yes, we're pet-friendly! We welcome cats and dogs up to 50lbs with a $300 deposit. Would you like to schedule a tour?",
    },
  ])
  ...
  const integrations = ["AppFolio", "Buildium", "Yardi", "Google Calendar", "Twilio", "HubSpot"]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:block">
              <Button className="bg-amber-500 hover:bg-amber-600 text-white">Book Demo</Button>
            </div>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-t border-gray-200">
            <div className="px-4 py-4">
              <Button className="w-full bg-amber-500 hover:bg-amber-600 text-white">Book Demo</Button>
            </div>
          </div>
        )}
      </nav>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              ...
              <div className="mt-8">
                <Button
                  size="lg"
                  className="bg-amber-500 hover:bg-amber-600 text-white text-lg px-8 py-4 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300"
                >
                  Book Demo
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <Card className="border-0 shadow-lg rounded-2xl">
              <CardContent className="p-8">
                ...
                <p className="text-lg text-zinc-700 mb-6">
                  "Our conversion rate increased by 35% in the first month. The AI is so natural, prospects love
                  chatting with it."
                </p>
                <div className="flex items-center">
                  <img
                    ...
                    <div key={index} className={`flex ${msg.type === "user" ? "justify-end" : "justify-start"}`}>
                      <div
                        className={`max-w-xs lg:max-w-md px-4 py-2 rounded-2xl ${
                          msg.type === "user" ? "bg-indigo-600 text-white" : "bg-white text-zinc-700 shadow-sm"
                        }`}
                      >
              ...
              <div className="p-4 border-t border-gray-200 bg-white rounded-b-2xl">
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    className="flex-1 px-4 py-2 border border-gray-300 rounded-2xl focus:outline-none focus:ring-2 focus:ring-indigo-600"
                  />
                  <Button size="sm" className="bg-indigo-600 hover:bg-indigo-700 text-white rounded-2xl">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 items-center">
            {integrations.map((integration, index) => (
              <div key={index} className="text-center">
                <div className="bg-gray-100 rounded-2xl p-6 h-20 flex items-center justify-center mb-2">
                  <span className="font-semibold text-zinc-700 text-sm">{integration}</span>
                </div>
              </div>
            ))}
          </div>
