      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="text-center md:text-left">
            <Link href="/" className="text-2xl font-bold text-indigo-600 mb-2 md:mb-0 block">
              AskMyAPT
            </Link>
            <p className="text-sm text-zinc-600">Privacy-first, Fair Housing-aware, and easy to audit.</p>
          </div>
          <nav aria-label="Footer" className="flex space-x-6 mt-4 md:mt-0">
